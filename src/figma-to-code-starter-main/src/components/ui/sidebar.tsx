      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+16px)]"
...
function SidebarTrigger({
  ...
  return (
    <button
      className={cn("inline-flex items-center justify-center size-7 rounded-md hover:bg-accent", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      className={cn(
        "absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
